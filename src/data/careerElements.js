let careerElements = [
  ...
  },
  {
    ...
    icon: "work",
    redirectLink: "https://developer.amazon.com/en-US/alexa/alexa-auto/sdk",
  },
  {
    id: 3,
    title: "GE Digital",
    ...
    icon: "work",
    redirectLink: "https://www.ge.com/digital/",
  },
  {
    id: 4,
    title: "Simcoach Games",
    subtitle: "Game Programmer (C#, Unity)",
    list: [
      "Developed and published 2 Android/iOS games to improve community awareness for local businesses.",
      "Implemented a Unity framework to track player statistics and evaluate in-game performance.",
    ],
    date: "May 2015 - August 2015",
    icon: "work",
    redirectLink: "https://www.simcoachgames.com/",
  },
  {
    id: 5,
    title: "Carnegie Mellon University",
    subtitle: "Master of Entertainment Technology",
    description: "Master of Entertainment Technology",
    date: "2014 - 2016",
    icon: "school",
    redirectLink: "https://www.etc.cmu.edu/",
  },
  {
    id: 6,
    ...
    date: "2010 - 2014",
    icon: "school",
    redirectLink: "https://engineering.virginia.edu/departments/computer-science",
  },
];

export default careerElements;
